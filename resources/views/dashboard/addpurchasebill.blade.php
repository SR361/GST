...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark">{{ trans('app.Add Purchase Bill') }}</h1>
			</div>
			<!-- /.col -->
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="{{ url(app()->getLocale().'/dashboard') }}">{{ trans('app.Home') }}</a></li>
					<li class="breadcrumb-item"><a href="{{ url(app()->getLocale().'/purchases') }}">{{ trans('app.Purchase Bill List') }}</a></li>
					<li class="breadcrumb-item active">{{ trans('app.Add Purchase Bill') }}</li>
				</ol>
			</div>
			<!-- /.col -->
		</div>
...
<section class="content">
	<div class="col-md-12">
		<div class="col-md-12">
			...
			<form action="{{ route('purchasebills.update',[app()->getLocale(),$Tbl_invoice->id]) }}" method="POST"  id="form_data" enctype="multipart/form-data" autocomplete="off">
				<input type="hidden" value="{{ $Tbl_invoice->id }}" name="id"> 
				@method('PUT')      
				@else
				<form action="{{ route('purchasebills.store',app()->getLocale()) }}" method="POST" id="form_data"  enctype="multipart/form-data" autocomplete="off">     
					@endif
					@csrf
					<div class="card">
						<div class="card-body">
							<div class="row">
								<div class="col-md-8 col-sm-12 col-xs-12">
									<div class="form-group input-group">
										...
										<div class="col-md-2 m-t-5">
											<div class="btn btn-primary" data-toggle="modal" data-target="#Add_client_modal">{{ trans('app.Add Vendor') }}</div>
										</div>
									</div>
								...
								<div class="col-md-4 col-sm-4 col-xs-12">
										...
										<div class="col-md-12">
											<div class="form-group input-group">
												<div class="col-md-4 m-t-5">
													<label>{{ trans('app.Purchase Bill number') }}</label>
												</div>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group input-group">
												<div class="col-md-4 m-t-5">
													<label>{{ trans('app.Purchase Bill Date') }}</label>
												</div>
												<div class="col-md-8 col-sm-8">
