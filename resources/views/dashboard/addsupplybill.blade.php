...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark">{{ trans('app.Add Supply Bill') }}</h1>
			</div>
			<!-- /.col -->
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="{{ url(app()->getLocale().'/dashboard') }}">{{ trans('app.Home') }}</a></li>
					<li class="breadcrumb-item"><a href="{{ url(app()->getLocale().'/invoices') }}">{{ trans('app.Supply Bill List') }}</a></li>
					<li class="breadcrumb-item active">{{ trans('app.Add Supply Bill') }}</li>
				</ol>
			</div>
			<!-- /.col -->
		</div>
...
<section class="content">
	<div class="col-md-12">
		<div class="col-md-12">
			...
			<form action="{{ route('supplybills.update',[app()->getLocale(),$Tbl_invoice->id]) }}" method="POST"  id="form_data" enctype="multipart/form-data" autocomplete="off">
				<input type="hidden" value="{{ $Tbl_invoice->id }}" name="id"> 
				@method('PUT')      
				@else
				<form action="{{ route('supplybills.store',app()->getLocale()) }}" method="POST" id="form_data"  enctype="multipart/form-data" autocomplete="off">     
					@endif
					@csrf
					<div class="card">
						<div class="card-body">
								...
								<div class="col-md-4 col-sm-4 col-xs-12">
										...
										<div class="col-md-12">
											<div class="form-group input-group">
												<div class="col-md-4 m-t-5">
													<label>{{ trans('app.Supply Bill Number') }}</label>
												</div>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group input-group">
												<div class="col-md-4 m-t-5">
													<label>{{ trans('app.Supply Bill Date') }}</label>
												</div>
												<div class="col-md-8 col-sm-8">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group input-group">
												...
												<div class="col-md-8 col-sm-8">
													<select name="place_supply" id="place_supply" class="select2">
              ...
              <div class="col-12 row">
                <div class="col-6">
                  ...
                  <textarea class="form-control" name="note">@if(isset($Tbl_invoice)){{ $Tbl_invoice->note }}@endif</textarea>
                </div>
                <div class="col-6">
