  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>{{ trans('app.Invoice') }}</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">{{ trans('app.Home') }}</a></li>
              <li class="breadcrumb-item active">{{ trans('app.Invoice') }}</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-12">
            <div class="invoice p-3 mb-3">
              ...
              <div class="row no-print">
                <div class="col-12">
                  <div onclick="window.print();return false;" class="btn btn-success"><i class="fa fa-print"></i> Print</div> <!--btn btn-default -->
                 <!--  <button type="button" class="btn btn-success float-right"><i class="fa fa-credit-card"></i> Submit
                    Payment
                  </button>
                  <a href="{{ route('invoicegeneratePDF',[app()->getLocale(),$invoice->id]) }}" target="_blank" class="btn btn-primary float-right" style="margin-right: 5px;">
